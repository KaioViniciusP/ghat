...
export default function Login({ isDark, setIsDark, email, setEmail, onBack, onRegister, onForgotPassword, onLogin }: LoginProps) {
      ...
      >
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold">
            <span style={{ color: isDark ? "#e63946" : "#1d1d1b" }}>G</span>hat Login
          </h1>
        </div>
